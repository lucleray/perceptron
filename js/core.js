...
web build:
 - http://mootools.net/core/1cd48746b3aa0b0d8cf94156cc6ed3b1

packager build:
 - packager build Core/Core Core/Array Core/String Core/Element.Delegation Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.HTML Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady Core/Swiff
